 ...
 */
unsigned int cyg_crc32_accumulate(unsigned int crc32val, const unsigned char* s,
    int len) {
    int i;
 ...
 * algorithm.
 */
unsigned int cyg_ether_crc32_accumulate(unsigned int crc32val, const unsigned char* s,
    int len) {
    int i;
